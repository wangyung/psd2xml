  ...
  if (d->__nonoption_flags_len > 0 && top >= d->__nonoption_flags_max_len)
      ...
      else
	{
	  memset (__mempcpy (new_str, __getopt_nonoption_flags,
			     d->__nonoption_flags_max_len * sizeof(char)),
		  '\0', (top + 1 - d->__nonoption_flags_max_len) * sizeof(char));
		    ...
		    struct _getopt_data *d)
{
  ...
  d->__posixly_correct = !!getenv (_T("POSIXLY_CORRECT"));
  ...
  if (!d->__posixly_correct
      ...
      if (d->__nonoption_flags_max_len == 0)
	{
	  if (__getopt_nonoption_flags == NULL
	      || __getopt_nonoption_flags[0] == _T('\0'))
		...
		memset (__mempcpy (__getopt_nonoption_flags, orig_str, len * sizeof(char)),
			'\0', (d->__nonoption_flags_max_len - len) * sizeof(char));
	    }
	}
...
# define NONOPTION_P (argv[d->optind][0] != _T('-') || argv[d->optind][1] == _T('\0') \
			  ...
			  && __getopt_nonoption_flags[d->optind] == _T('1')))
#else
# define NONOPTION_P (argv[d->optind][0] != _T('-') || argv[d->optind][1] == _T('\0'))
#endif
  ...
  while (1)
	...
	case _T('9'):
	  if (digit_optind != 0 && digit_optind != this_option_optind)
	    printf (_T("digits occur in two different argv-elements.\n"));
	...
	case _T('c'):
	  printf (_T("option c with value '%s'\n"), optarg);
	  break;

	case _T('d'):
	  printf (_T("option d with value '%s'\n"), optarg);
	  break;
	...
	default:
	  printf (_T("?? getopt returned character code 0%o ??\n"), c);
	}
    }
